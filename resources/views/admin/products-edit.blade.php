        ...
        <div class="main-content-wrap">
            ...
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.product.update') }}">
                ...
                <div class="wg-box">
                    ...
                    <fieldset class="whychoose">
                        <div class="body-title mb-10">Why Choose<span class="tf-color-1">*</span>
                        </div>
                        <textarea class="mb-10" name="whychoose" placeholder="Why Choose" tabindex="0" aria-required="true" required="">{{ $product->whychoose }}</textarea>
                        <div class="text-tiny">Do not exceed 100 characters when entering the
                            product name.</div>
                    </fieldset>
                    @error('whychoose') <span class="alert alert-danger text-center">{{ $message }}</span> @enderror
                </div>
                <div class="wg-box">
                    <fieldset>
